...
| `codimension/utils/encoding.py` (частково) | `getCodingFromText`, `detectFileEncodingToRead`, `readEncodedFile` | editor param | ✅ 0.20.3 `read_encoded_bytes` + injectable fallbacks in core |
