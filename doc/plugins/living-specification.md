...
| **codimension_core file_io** | codimension_core.file_io | JSON/text read/write | unit: tests/test_codimension_core_file_io.py |
...
| **MCP catalog drift guard** | tests/test_codimension_mcp_catalog.py, catalog_readme.py | catalog ↔ vscode ↔ README (generated) ↔ root README | CI: verify-mcp-catalog.sh + generate --check |
