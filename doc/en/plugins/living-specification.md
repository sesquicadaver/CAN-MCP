...
Matrix «module → tests → CI». Updated on extraction per [CODIMENSION-CORE-MAP.md](../CODIMENSION-CORE-MAP.md).

---

## 1. Module → tests matrix
...
On extraction or new MCP tool:

1. Update [CODIMENSION-CORE-MAP.md](../CODIMENSION-CORE-MAP.md) (EN and UK).
2. Add or update a row in section 1.
3. Run `./scripts/test-analysis.sh`.
